...
type Stub struct {
	...
	// Track if this stub was generated by proxy recording
	// Used for DELETE /imposters/:id/requests to remove proxy-generated stubs
	IsProxyGenerated bool `json:"-"`
}
...
type PredicateGen struct {
	Matches       interface{} `json:"matches,omitempty"`
	Inject        string      `json:"inject,omitempty"` // JavaScript function to generate predicates
	CaseSensitive bool        `json:"caseSensitive,omitempty"`
	XPath         *Selector   `json:"xpath,omitempty"`
	JSONPath      *Selector   `json:"jsonpath,omitempty"`
}
